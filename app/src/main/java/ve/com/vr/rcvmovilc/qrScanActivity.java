        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (qrcodes.size() != 0) {
                    ...
                    vibrator.vibrate(100);// R.integer.tiempo_vibracion_milisegundo);

                    //txtResult.setText(qrcodes.valueAt(0).displayValue);

                    Intent vIntent =  new Intent(qrScanActivity.this, ResultadoQRActivity.class );
                    String  vPrm = getIntent().getExtras().getString("prmOptOrigen").toString();
                    vIntent.putExtra("prmOptOrigen", vPrm );
                  //  vIntent.putExtra("prmValorOrigen", qrcodes.valueAt(0).displayValue);
